...
| Market Data Foundation (Steps A–C) | `lib/market-data/` | Provider-neutral quotes/candles; workspace read path; `WorkspaceDataQuality` awareness for UI (scores/paper unchanged) |
