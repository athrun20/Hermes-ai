import type { ChartIntelligenceLabel } from "@/lib/chart-intelligence-types";

export function ChartIntelligenceLabels({
  labels,
  priceRange,
  fallbackPrice,
}: {
...
function labelTone(tone: ChartIntelligenceLabel["tone"]) {
